...
class UsersRepositoryImplTest {
    ...
    @Test
    fun `given users exist when getUsers is called then returns Success with list of User`() =
        runTest {
            // Given
    ...
    @Test
    fun `given api throws when getUsers is called then returns Error Unknown`() =
        runTest {
            // Given
    ...
    @Test
    fun `given api throws when findUsers is called then returns Error Unknown`() =
        runTest {
            // Given
            val repo = createRepository(shouldThrow = true)
    ...
    @Test
    fun `given api throws when getUserMe is called then returns Error Unknown`() =
        runTest {
            // Given
            val repo = createRepository(shouldThrow = true)
    ...
    @Test
    fun `given valid id when findById is called then returns Success with User`() =
        runTest {
            // Given
            val repo = createRepository()
    ...
    @Test
    fun `given valid id and imageUrl when updatePhoto is called then returns Success true`() =
        runTest {
            // Given
            val repo = createRepository()
    ...
    @Test
    fun `given api throws when updatePhoto is called then returns Error Unknown`() =
        runTest {
            // Given
            val repo = createRepository(shouldThrow = true)
    ...
    @Test
    fun `given valid params when getPresignedUrl is called then returns Success with PresignedUrlData`() =
        runTest {
            // Given
            val repo = createRepository()
    ...
    @Test
    fun `given api throws when getPresignedUrl is called then returns Error Unknown`() =
        runTest {
            // Given
            val repo = createRepository(shouldThrow = true)
    ...
    @Test
    fun `given a user when saveUser is called then currentUser emits the saved user`() =
        runTest {
            // Given
            val repo = createRepository()
            val user =
    ...
    @Test
    fun `given a saved user when clearUser is called then currentUser emits null`() =
        runTest {
            // Given
            val repo = createRepository()
            val user =
