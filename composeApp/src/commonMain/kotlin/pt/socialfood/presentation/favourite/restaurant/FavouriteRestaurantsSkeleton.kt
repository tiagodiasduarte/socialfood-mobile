...
fun FavouriteRestaurantsSkeleton(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        repeat(SKELETON_ITEM_COUNT) {
            FavouriteRestaurantCardSkeleton(alpha = alpha)
        }
    }
}

@Composable
private fun FavouriteRestaurantCardSkeleton(alpha: Float, modifier: Modifier = Modifier) {
    Card(
        ...
        Column(
            ...
            FavouriteRestaurantCardInfoRowSkeleton(alpha = alpha)
...
@Composable
private fun FavouriteRestaurantCardInfoRowSkeleton(alpha: Float) {
    Row(
        modifier = Modifier.fillMaxWidth(),
