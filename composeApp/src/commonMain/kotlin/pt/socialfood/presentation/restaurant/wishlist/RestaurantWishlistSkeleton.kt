...
private const val BOTTOM_BUTTON_COUNT = 2
...
fun RestaurantWishlistSkeleton(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        repeat(SKELETON_ITEM_COUNT) {
            WishlistCardSkeleton(alpha = alpha)
        }
    }
}

@Composable
private fun WishlistCardSkeleton(alpha: Float, modifier: Modifier = Modifier) {
    Card(
        ...
        Column(
            ...
            WishlistCardInfoRowSkeleton(alpha = alpha)
...
@Composable
private fun WishlistCardInfoRowSkeleton(alpha: Float) {
    Row(
        modifier = Modifier.fillMaxWidth(),
