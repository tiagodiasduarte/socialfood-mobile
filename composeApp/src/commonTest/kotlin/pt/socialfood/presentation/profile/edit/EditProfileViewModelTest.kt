...
class EditProfileViewModelTest {
    ...
    private val presignedUrlData = PresignedUrlData(
    ...
    @Test
    fun `given the S3 upload fails when save is called then the user photo is not updated`() = runTestWithMainDispatcher {
        // Given
