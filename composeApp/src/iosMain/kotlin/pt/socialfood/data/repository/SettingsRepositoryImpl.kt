...
private const val KEY_LAST_RESTAURANT_VISIT_STATUS_SYNC_SYNCED_AT = "last_restaurant_visit_status_synced_at"
private const val KEY_LAST_RESTAURANT_VISIT_STATUS_SYNC_ATTEMPT_AT = "last_restaurant_visit_status_attempt_at"
...
class SettingsRepositoryImpl : SettingsRepository {
    ...
    override suspend fun getLastRestaurantVisitStatusSyncedAt(status: VisitStatus): String? =
        defaults.stringForKey(KEY_LAST_RESTAURANT_VISIT_STATUS_SYNC_SYNCED_AT)

    override suspend fun saveLastRestaurantVisitStatusSyncedAt(status: VisitStatus, syncedAt: String) {
        defaults.setObject(syncedAt, KEY_LAST_RESTAURANT_VISIT_STATUS_SYNC_SYNCED_AT)
    }
